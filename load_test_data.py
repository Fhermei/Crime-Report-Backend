...
Matches the data described in the write-up
...
if created:
    ...
    admin.set_password('Admin@123')
    admin.save()
    print("  ℹ️ Admin already exists - password reset to Admin@123")
...
for data in police_data:
    ...
    if created:
        ...
        user.set_password('Police@123')
        user.save()
        print(f"  ℹ️ Police {data['first']} already exists - password reset")
...
for data in citizen_data:
    ...
    if created:
        ...
        user.set_password('Citizen@123')
        user.save()
        print(f"  ℹ️ Citizen {data['first']} already exists - password reset")
...
print("\n" + "=" * 60)
print("📝 CREATING 50 CRIME REPORTS")
print("=" * 60)
